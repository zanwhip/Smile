        ...
        <table>
          <tbody>
            <tr>
              <td>
                <img
                 img className="image" src={nf1} alt="Newfeed1" style={{ width : '100%', height : '100%' }}
                />
              </td>
            </tr>
            <tr>
              <td style={{ fontWeight : 'bold' , fontSize : 20, textAlign : 'left'}}>Ford Việt Nam hỗ trợ gần 500 triệu đồng ủng hộ người dân miền Trung tái ổn định cuộc sống sau thiên tai</td>
            </tr>
            <tr>
              <td style={{ display : 'flex', justifyContent : 'flex-start' }}>

                <div style={{ marginRight : 100, display : 'flex' }}>
                <img src={avatar} className='avatar' style={{ marginRight : 10, height : 25 }}/>
                <div style={{ marginTop : 3 }}>Nguyen Van A</div>
                </div>

                <div style={{ marginRight : 100, display : 'flex' }}>
                <img src={calendar} className='avatar' style={{ marginRight : 10, height : 25 }}/>
                <div style={{ marginTop: 3 }}>12 Sep 2021</div>
                </div>
                
                <div style={{ marginRight : 100, display : 'flex' }}>
                <img src={clock} className='avatar' style={{ marginRight : 10, height : 25 }}/>
            ...
            <tr>
              <td style={{ textAlign : 'justify' }}>Ngày 4/11/2020, hưởng ứng lời kêu gọi của Chính phủ và Ủy ban Trung ương Mặt trận tổ quốc Việt Nam (MTTQ), Ford Việt Nam đã chung tay cùng CLB Bán tải Việt Nam (PVC), Trung tâm Sống và Học tập vì Môi trường và Cộng đồng (Live & Learn Vietnam), thông qua nhóm từ thiện Chân Trần hỗ trợ hơn 640 gói nhu yếu phẩm cho các 
                hộ dân và đồ dùng học tập cho 815 trẻ nhỏ ở hai xã Avao huyện Dakrong và Hướng Việt huyện Hướng Hóa, tỉnh Quảng Trị.
                Cụ thể, Ford Việt Nam sẽ trao tặng khoảng 640 suất đồ dùng thiết yếu cho các gia đình tại xã Avao huyện Dakrong và Hướng Việt, huyện Hướng Hóa. Hai xã này bị cô lập suốt cả tháng 10 và vừa thoát ngập đầu tuần vừa rồi, hiện bùn đất vẫn ngập ngang gối và chỉ có một con đường có thể tiếp cận xã vòng qua Quảng Bình
                </td>
            </tr>
            <tr>
              <td>
                    <div className='ContainerIcon' style={{ display : 'flex' , height : 40, justifyContent : 'space-between', alignItems : 'center' }}>
                        <img src={groupIcon} style={{ height : 30 , marginLeft : 20}}/>
                        <div style={{ display : 'flex', marginRight : 10 }}>
                        <img src={ellipse1} style={{ height : 30}}/>
                        <img src={ellipse2} style={{ height : 30}}/>
                        <img src={ellipse3} style={{ height : 30}}/>
                        <div style={{ marginTop: 3 }}>Nguyễn Văn Hùng, Phạm Văn Nam và 30 người khác</div>
                        </div>
                    </div>
            </td>
            </tr>
...
<div style={{ marginTop : 30, display : 'flex' , justifyContent : 'center' }} >
  <img src={num1} style={{ width : 20 , height : 20, marginRight : 8 }}/>
  <img src={num2} style={{ width : 20 , height : 20, marginRight : 8 }}/>
  <img src={num3} style={{ width : 20 , height : 20, marginRight : 8 }}/>
  <img src={num} style={{ width : 20 , height : 20, marginRight : 8 }}/>
  <img src={arrow} style={{ width : 20 , height : 20, marginRight : 8 }}/>
        ...
        <div className='LatestNews'>
            <div className='Category' >
              <div style={{ marginLeft : 15 , marginRight : 15 }}  >
                ...
                <div style={{ width: 50, border: "1px #219D80 solid", marginTop : 1 }} />
                <div style={{ width: 200, border: "1px #E3E3E3 solid", marginTop : 30 }} />
                <div style={{ display : 'flex', justifyContent : 'space-between', marginTop : 10  }}>
                    <div>Giáo Dục</div>
                    <div>(10)</div>
                </div>

                <div style={{ width: 200, border: "1px #E3E3E3 solid", marginTop : 10 }} />
                <div style={{ display : 'flex', justifyContent : 'space-between', marginTop : 10  }}>
                    <div>Kinh Tế</div>
                    <div>(6)</div>
                </div>
              ...
              <div className='font_category'  >Bài Viết Gần Đây</div>
                ...
                <div style={{ marginTop : 20 , display : 'flex' }} >
                    ...
                    <div style={{ marginLeft : 7 }}>
                      <div className='Title'>Xóa Mù Chữ Cho Các Em Nhỏ Vùng Cao</div>
          ...
          <div className='Category' style={{ marginTop : 50, height : 150 }} >
            ...
            <div className='font_category'  >Từ Khóa Phổ Biến</div>
                <div style={{ width: 50, border: "1px #219D80 solid", marginTop : 1 , marginBottom : 20}} />
